...
@Component({
  selector: 'app-add-component2',
  templateUrl: './add-component2.component.html',
  styleUrls: ['./add-component2.component.css']
})
export class AddComponent2Component {
...
showErrorModel:string
  ...
  //component-1
    ...
    constructor(public loginService:LoginService,public component2Service:AddComponent2Service,private router:Router){}
    ngOnInit(): void {
  ...
  getComponentDef(){
    this.component2Service.getComponentDef().subscribe((data)=>{
    ...
    addNewComponent(){
      this.component2Service.addNewComponent1(this.addComponent.componentDef,this.componentImage1
    ...
    updateNewComponent(){
       this.component2Service.updateComponent1(this.updateComponent.componentDef,this.updatecomponentImage1,this.updatecomponentImage2,this.updatecomponentImage2).subscribe((data)=>{
        $('#statussuccesssModal').show();
